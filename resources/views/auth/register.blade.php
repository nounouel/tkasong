                ...
                <div class="relative flex w-full max-w-[1502px] flex-col justify-between overflow-hidden rounded-md bg-white/60 backdrop-blur-lg dark:bg-black/50 lg:min-h-[758px] lg:flex-row lg:gap-10 xl:gap-0">
                    <div class="relative hidden w-full items-center justify-center bg-[linear-gradient(225deg,rgba(239,18,98,1)_0%,rgba(67,97,238,1)_100%)] p-5 lg:inline-flex lg:max-w-[835px] xl:-ms-28 ltr:xl:skew-x-[14deg] rtl:xl:skew-x-[-14deg]">
                        ...
                        <div class="ltr:xl:-skew-x-[14deg] rtl:xl:skew-x-[14deg]">
                            <a href="{{ route('home')}}" class="w-48 block lg:w-72 ms-10">
                                <!-- <img src="{{ URL::to('assets/images/auth/logo-white.png') }}" alt="Logo" class="w-full"> -->
                            </a>
                            <div class="mt-24 hidden w-full max-w-[430px] lg:block">
                                <img src="{{ URL::to('assets/images/auth/register.svg') }}" alt="Cover Image" class="w-full">
                            </div>
                        </div>
                    </div>
                    <div class="relative flex w-full flex-col items-center justify-center gap-6 px-4 pb-16 pt-6 sm:px-6 lg:max-w-[667px]">
                        <div class="flex w-full max-w-[440px] items-center gap-2 lg:absolute lg:end-6 lg:top-6 lg:max-w-full">
                            <a href="{{ route('home')}}" class="block w-8 lg:hidden">
                                <img src="{{ URL::to('assets/images/logo.png') }}" alt="Logo" class="w-full">
                            </a>
                        ...
                        <div class="w-full max-w-[440px] lg:mt-16">
                            <div class="mb-10">
                                ...
                                <p class="text-base font-bold leading-normal text-white-dark">Enter your details to register</p>
                            </div>
                            <form id="register" class="space-y-5 dark:text-white" action="{{ route('register') }}" method="POST">
                                @csrf
                                <div>
                                    <label for="Name">Name</label>
                                    <div class="relative text-white-dark">
                                        <input id="Name" type="text" name="name" placeholder="Enter Name" class="form-input ps-10 placeholder:text-white-dark" value="{{ old('name') }}" required>
                    ...
                    <br>
                            <div class="text-center dark:text-white">
                                ...
                                <a href="{{ route('login') }}" class="uppercase text-primary underline transition hover:text-black dark:hover:text-white">SIGN IN</a>
                            </div>
                        </div>
